...
void(string s, string s2) dprint2               = #25;
void(string s, string s2, string s3) dprint3               = #25;
void(string s, string s2, string s3, string s4) dprint4               = #25;
...
.float ready;  // is the player ready?
.float cnt2;   // seconds for the timer. cnt is minutes
...
.float k_666;
.float k_1spawn;
.float k_flag;	//general code-flag...
.float k_admin;
.float k_adminc;
.float k_added;
.float k_accepted;
